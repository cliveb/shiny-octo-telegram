        ...
        yield new Promise((resolveEphemeralServer, rejectEphemeralServer) => {
            const handler = (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const dataStr = yield functionsEmulatorShared_1.waitForBody(req);
                    if (dataStr && dataStr.length > 0) {
                        if (req.is("application/json")) {
                            new types_1.EmulatorLog("DEBUG", "runtime-status", `Detected JSON request body: ${dataStr}`).log();
...
function ProcessBackground(frb, trigger) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const makeFirestoreSnapshot = app.firestore().snapshot_.bind(app.firestore());
        const resourcePath = proto.context.resource.name;
        const params = functionsEmulatorUtils_1.extractParamsFromPath(trigger.definition.eventTrigger.resource, resourcePath);
        let newSnap;
        if (proto.data.value) {
        ...
        new types_1.EmulatorLog("DEBUG", "runtime-status", `Requesting a wrapped function.`).log();
        ...
        yield Run([data, ctx], func);
    });
}
function Run(args, func) {
    return __awaiter(this, void 0, void 0, function* () {
        if (args.length < 2) {
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!app) {
            new types_1.EmulatorLog("SYSTEM", "admin-not-initialized", "").log();
            return;
        }
        let seconds = 0;
