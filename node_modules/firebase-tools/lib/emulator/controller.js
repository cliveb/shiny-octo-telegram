...
function startAll(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (targets.indexOf(types_1.Emulators.FIRESTORE) > -1) {
            ...
            const firestoreEmulator = new firestoreEmulator_1.FirestoreEmulator({
        ...
        if (targets.indexOf(types_1.Emulators.DATABASE) > -1) {
            ...
            const databaseEmulator = new databaseEmulator_1.DatabaseEmulator({
                host: databaseAddr.host,
                port: databaseAddr.port,
            });
            yield startEmulator(databaseEmulator);
            utils.logWarning(`Note: the database emulator is not currently integrated with the functions emulator.`);
        }
